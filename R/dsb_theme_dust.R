...
#'
#' This function applies a warm theme consistent with the DSB Corporate Visual Identity (CVI) to your `ggplot2` graphics. Add it to your `ggplot2` syntax for conistent visual outputs.
  ...
  p <-
    ...
    ggplot2::theme(axis.text.x = element_text(colour = theme_textcolor,
                   ...
                   strip.text = element_text(colour = theme_textcolor,
                                             face = "plain",
                                             size = 11),
                   strip.background = element_rect(color = theme_textcolor,
                                                   fill = scales::alpha("#E8E1D5",
                                                                        1.0)),
